...
I have a UniFi Security Gateway (USG) and a Cloud Key Gen2 Plus (UCK-G2-PLUS), and I want to update my Cloudflare domain name DNS records when my public IP address changes. Unfortunately, UniFi does not come pre-configured to support Cloudflare as one of its DDNS providers.
...
- `Service`: choose **namecheap** from the drop-down menu
